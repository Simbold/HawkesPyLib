...
<%def name="show_source(d)">
  % if (show_source_code or git_link_template) and d.source:
...
<%def name="show_desc(d, short=False)">
  ...
  docstring = d.docstring if short or inherits else d.docstring
  %>
  <div class="hslist">${docstring | to_html}</div>
