...
from HawkesPyLib.inference import SumExpHawkesProcessEstimation
import os 
...
class TestSumExpo_estimate(TestCase):
    """ 
    Test the SumExpHawkesProcessEstimation .estimate method.
    """
    def setUp(self):
    ...
    def test_sum_expo_estimate_calls_correct_custom(self):
        ...
        with mock.patch("HawkesPyLib.inference.uvhp_sum_expo_mle") as patched_function:
            SumExpoEst = SumExpHawkesProcessEstimation(self.P)
    ...
    def test_check_attributes(self):
        ...
        self.assertTrue(hasattr(SumExpoEst, "success_flag"))
        self.assertTrue(hasattr(SumExpoEst, "_opt_result"))
